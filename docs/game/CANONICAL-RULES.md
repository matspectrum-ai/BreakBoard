...
Effect chains cannot recurse forever. Exact strategy remains open.
...
Every battle has a termination mechanism.
...
Exact queue semantics remain in Mutation System v0.1.
...
### BB-VIC-004
Current anti-stall hypothesis: Collapse Phase after a threshold progressively forces resolution. Exact algorithm is open.

## Mutations
### BB-MUT-001
Every mutation is Piece, Board, or Rule.
### BB-MUT-002
Compatibility vocabulary: `requires`, `excludes`, `overrides`; contradictions are never arbitrarily resolved.
### BB-MUT-003
...
### BB-RNG-002
Movement/capture/effect resolution is deterministic; randomness generates options/content, not hidden arbitrary resolution.
